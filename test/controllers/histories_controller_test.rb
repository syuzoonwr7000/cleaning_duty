...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference("History.count") do
      post histories_url, params: { history: { date: @history.date, room202: @history.room202, soto1: @history.soto1, soto2: @history.soto2 } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { date: @history.date, room202: @history.room202, soto1: @history.soto1, soto2: @history.soto2 } }
